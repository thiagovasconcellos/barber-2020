...
describe('CreateUser', function () {
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, createUser, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUserRepository_1.default();
    ...
    it('should not be able to create a new user with exists email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, createUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUserRepository_1.default();
